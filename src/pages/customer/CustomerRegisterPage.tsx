    ...
    <div className="min-h-screen flex flex-col justify-between p-4 sm:p-6 lg:p-8 text-white">
      ...
      <div className="max-w-5xl mx-auto w-full my-auto py-4">
        <div className="glass-surface-elevated rounded-3xl overflow-hidden grid grid-cols-1 lg:grid-cols-12 border border-white/25 shadow-2xl">
          ...
          <div className="lg:col-span-5 relative min-h-[350px] lg:min-h-[560px] flex flex-col justify-end p-6 sm:p-8 overflow-hidden">
            <img
            ...
            <div className="relative z-10 space-y-3 max-w-sm">
              <div className="glass-feature-pill p-3 rounded-2xl flex items-center gap-3">
                ...
                <div>
                  <div className="text-xs font-black text-white">Direct Farm Origin</div>
                  <div className="text-[10px] text-white/80 font-medium">Know the exact farmer who grew your food</div>
                </div>
              </div>
              ...
              <div className="glass-feature-pill p-3 rounded-2xl flex items-center gap-3">
                ...
                <div>
                  <div className="text-xs font-black text-white">Residue-Free Guarantee</div>
                  <div className="text-[10px] text-white/80 font-medium">Naturally grown pure vegetables & fruits</div>
                </div>
              </div>
              ...
              <div className="glass-feature-pill p-3 rounded-2xl flex items-center gap-3">
                ...
                <div>
                  <div className="text-xs font-black text-white">Express Dispatch</div>
                  <div className="text-[10px] text-white/80 font-medium">Delivered quickly to your home</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-7 p-6 sm:p-9 flex flex-col justify-center glass-surface-subtle overflow-y-auto">
            ...
            <form onSubmit={handleSubmit} className="space-y-3">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                ...
                <div>
                  <label className="block text-[11px] font-bold text-white/80 mb-1">Delivery City</label>
                  <div className="relative">
